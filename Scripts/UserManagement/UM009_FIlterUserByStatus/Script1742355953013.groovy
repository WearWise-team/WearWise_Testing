...
WebUI.click(findTestObject('Object Repository/User_Management_Page/ddl_Status'))

WebUI.click(findTestObject('Object Repository/User_Management_Page/ddl_Active'))
...
boolean isFiltered = WebUI.verifyTextPresent('Active', false)

// In kết quả kiểm thử
if (isFiltered) {
	println('Test Passed: Users filtered by Status gender successfully.')
} else {
	println('Test Failed: Filtering by Status did not work as expected.')
}
