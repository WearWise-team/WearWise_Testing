...
WebUI.click(findTestObject('Object Repository/User_Management_Page/ddl_Role'))

WebUI.click(findTestObject('Object Repository/User_Management_Page/ddl_Admin'))
...
boolean isFiltered = WebUI.verifyTextPresent('Admin', false)

// In kết quả kiểm thử
if (isFiltered) {
	println('Test Passed: Users filtered by Role gender successfully.')
} else {
	println('Test Failed: Filtering by role did not work as expected.')
}
