...
WebUI.setText(findTestObject('Object Repository/Discount_Management_Page/txt_Code'), 'ShWBQA20')
WebUI.setText(findTestObject('Object Repository/Discount_Management_Page/txt_Description'), '20% off all spring collection')
WebUI.setText(findTestObject('Object Repository/Discount_Management_Page/txt_Percentage'), '20')
...
WebUI.verifyTextPresent('ShWBQA20', false)