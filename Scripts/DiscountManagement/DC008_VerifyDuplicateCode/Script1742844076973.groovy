...
WebUI.setText(findTestObject('Object Repository/Discount_Management_Page/txt_Code'), 'TSHIRT15')
...
WebUI.verifyTextPresent('The code has already been taken.', false)
